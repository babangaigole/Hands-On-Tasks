1. Create Deployment in an declarative way <br/>
    a) Create a Deployment <br/>
        Name: testdeploy <br/>
        Image: gaigoleb2/cuswebsrvhostname:v1 <br/>
        Replicas: 10 <br/>
        Strategy: Recreate <br/>
    b) Create a service to expose the Deployment <br/>
        Service name: test-svc <br/>
        Service type: NodePort <br/>
        port: 8000 <br/>
        targetPort: 80 <br/>
    c) Check website output using curl <br/>
    d) Perform upgrade using recreate strategy <br/>
        Image: gaigoleb2/cuswebsrvhostname:v2 <br/>
    e) Check the status of the upgrade <br/>
    f) Perform rollback upgrade <br/>
    g) Check the status of the upgrade <br/>
    h) Edit the deployment to perform upgrade using rolling upgrade strategy and this time record the version <br/>
